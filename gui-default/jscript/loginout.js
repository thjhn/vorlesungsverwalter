 ...
 */
		...
		jQuery().ready(function(){
			// remove the layer with information about js
			$("#nojs").remove();
					...
					$("#loginbutton").on('click',function(e){
						...
						$.ajax({
							...
							if(msg.success=='yes'){
								...
								showErrorMsg("Anmeldung fehlgeschlagen! Die Logininformationen sind falsch.");
							}
						});
						...
						$.ajax({
							...
							if(tool.status=='ok'){
								...
								$.ajax({		
									...
									dataType:"script",
									type:"post",
									data:{cmd:"GET_TOOL_SCRIPT",data:key}
								}).done(function(){
									// nothing to be done.
								});
							}else{
